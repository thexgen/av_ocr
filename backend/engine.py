...
from backend.config import OUTPUT_PREFIX, UPLOADS_PREFIX, cfg
from backend.exceptions import UnsupportedDocumentError
...
from backend.job.models import UploadHistory, utc_now_iso
from backend.logging_setup import bind_job, set_stage
    ...
    def register_upload(
        ...
        *,
        ...
        if ext not in supported:
            ...
            from backend.pipeline.validation import build_validation_report
