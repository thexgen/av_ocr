...
# Legacy Qwen / DashScope (optional fallback — prefer Bedrock)
...
# Amazon Bedrock (Nova Lite) — preferred LLM
AWS_REGION: str = os.getenv("AWS_REGION", "ap-south-2")
AWS_ACCESS_KEY_ID: str = os.getenv("AWS_ACCESS_KEY_ID", "")
AWS_SECRET_ACCESS_KEY: str = os.getenv("AWS_SECRET_ACCESS_KEY", "")
BEDROCK_REGION: str = os.getenv("BEDROCK_REGION") or os.getenv("AWS_REGION") or "us-east-1"
BEDROCK_MODEL_ID: str = os.getenv("BEDROCK_MODEL_ID", "us.amazon.nova-lite-v1:0")
LLM_MAX_TOKENS: int = int(os.getenv("LLM_MAX_TOKENS") or "512")
LLM_MAX_INPUT_CHARS: int = int(os.getenv("LLM_MAX_INPUT_CHARS") or "3000")
