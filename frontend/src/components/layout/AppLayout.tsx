...
import { ChatProvider } from '../../features/jessy/chat/ChatProvider'
import { ChatWidget } from '../../features/jessy/chat/ChatWidget'
  ...
  return (
    <ChatProvider>
      <div className="relative min-h-screen">
        ...
        {/* Outside route AnimatePresence so chat history survives navigation */}
        <ChatWidget />
      </div>
    </ChatProvider>
  )
